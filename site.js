...
roomButtons.forEach(function (roomButton) {
  roomButton.onclick = function () {
    ...
    if (roomButton.value === "twin-bed") {
      roomType.value = "Twin Bed";
    } else if (roomButton.value === "suite") {
      roomType.value = "Suite";
    } else if (roomButton.value === "double-bed") {
      roomType.value = "Double Bed";
    } else if (roomButton.value === "single-bed") {
      roomType.value = "Single Bed";
    }
  };
});
